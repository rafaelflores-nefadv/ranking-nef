...
<head>
    ...
    <style>
        ...
        /* Sistema de estrelas animadas no background */
        .stars-background {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="font-sans antialiased bg-[#0a0e1a] w-screen h-screen overflow-hidden">
    ...
    <script>
        ...
        console.log('Monitor Cosmic: DASHBOARD_CONFIG carregado', {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!monitorVoiceEnabled || !systemVoiceEnabled || !['browser', 'both'].includes(voiceMode)) {
                console.log('Monitor Cosmic: Leitura por voz desabilitada', {
                    monitorVoiceEnabled,
                    systemVoiceEnabled,
                    voiceMode
                });
            ...
            if (!('speechSynthesis' in window)) {
                console.warn('Monitor Cosmic: SpeechSynthesis não suportado no navegador');
                return;
            }
            ...
            const fetchVoiceEntries = async () => {
                ...
                try {
                    ...
                    if (monitorSlug) {
                        params.append('monitor', monitorSlug);
                    }
                    ...
                    console.error('Monitor Cosmic: Erro ao buscar leitura por voz:', error);
                }
            };

            console.log('Monitor Cosmic: Leitura por voz habilitada');
            fetchVoiceEntries();
