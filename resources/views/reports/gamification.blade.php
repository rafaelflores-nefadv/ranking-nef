    ...
    <div class="max-w-7xl mx-auto">
        ...
        @if($isAdmin && isset($sectorOptions) && $sectorOptions->isNotEmpty())
            ...
            <div class="bg-slate-900/40 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6 mb-6">
                <form method="GET" action="{{ route('reports.gamification') }}" class="flex gap-4 items-end">
                    <div class="flex-1">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('reports.gamification') }}" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg">
                            Limpar
                        </a>
                    </div>
                </form>
